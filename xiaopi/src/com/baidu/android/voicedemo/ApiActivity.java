...
public class ApiActivity extends Activity implements RecognitionListener {
    ...
    public void bindParams(Intent intent) {
        ...
        if (sp.contains(Constant.EXTRA_IP)) {
            HOST = sp.getString(Constant.EXTRA_IP,"");
        }
        if (sp.contains(Constant.EXTRA_PORT)) {
            PORT = sp.getString(Constant.EXTRA_PORT,"");
        }
    ...
    public void onResults(Bundle results) {
        ...
        print (nbest.get(0));
        final String words = nbest.get(0).toString();
